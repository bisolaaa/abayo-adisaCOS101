fn main() {
    ...
    let w3 = w1 + &w2;   // wk2 reference is passed
    println!();
    println!("{} is aimed at developing competent, creative,innovative, entrepreneurial and ethically-minded persons, capable of creating value is the diverse fields of Computer Science. ",w3);
}
